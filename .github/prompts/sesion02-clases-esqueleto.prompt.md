...
## Paso 1.4 — Preguntar el reparto de trabajo entre los miembros del equipo

Solo después de confirmar las clases del sistema, preguntar al equipo cómo se va a repartir
el trabajo. Esta decisión es clave para que ambos miembros puedan trabajar en paralelo
sin generar conflictos en Git.

> *"Ahora que ya sabemos qué clases vamos a implementar, decidid cómo os las repartís.*
> *¿Qué clases va a implementar cada uno?*
>
> *Por ejemplo, si tenéis `Aula`, `Profesor` y `Reserva`:*
> *— Miembro A → `Aula`, `Profesor`*
> *— Miembro B → `Reserva`*
>
> *¿Cómo lo repartís vosotros? (Si trabajáis en solitario, indicadlo también)*"*
